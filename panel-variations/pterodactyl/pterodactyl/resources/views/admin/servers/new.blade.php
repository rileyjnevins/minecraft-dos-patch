    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                ...
                <div class="box-body row">
                    <div class="form-group col-xs-6">
                        <label for="pIngress">Inbound Traffic Limit</label>

                        <div class="input-group">
                            <input type="text" id="pIngress" name="ingress" class="form-control" value="{{ old('ingress', 0) }}" />
                            <span class="input-group-addon">KB/s</span>
                        </div>

                        <p class="text-muted small">Determines the maximum amount of traffic that can pass into the container measured in KB/s. Set to <code>0</code> to allow an unlimited amount of inbound traffic.</p>
                    </div>

                    <div class="form-group col-xs-6">
                        <label for="pEgress">Outbound Traffic Limit</label>

                        <div class="input-group">
                            <input type="text" id="pEgress" name="egress" class="form-control" value="{{ old('egress', 0) }}" />
                            <span class="input-group-addon">KB/s</span>
                        </div>

                        <p class="text-muted small">Determines the maximum amount of traffic that can pass out from the container measured in KB/s. Set to <code>0</code> to allow an unlimited amount of outbound traffic.</p>
                    </div>
