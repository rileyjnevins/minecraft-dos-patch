        ...
        <div class="col-sm-7">
            <div class="row">
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Bandwidth Limits</h3>
                        </div>
                        <div class="box-body">
                            <div class="form-group">
                                <div class="form-group">
                                    <label for="ingress" class="control-label">Inbound Limit</label>
                                    <div class="input-group">
                                        <input type="text" name="ingress" class="form-control" value="{{ old('ingress', $server->ingress) }}"/>
                                        <span class="input-group-addon">KB/s</span>
                                    </div>
                                    <p class="text-muted small">Limits the amount of inbound/ingress traffic that can pass into the server, measured in <code>KB/s</code>. Setting this value to <code>0</code> will allow a server to use as much inbound bandwidth as necessary.</p>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="form-group">
                                    <label for="egress" class="control-label">Outbound Limit</label>
                                    <div class="input-group">
                                        <input type="text" name="egress" class="form-control" value="{{ old('egress', $server->egress) }}"/>
                                        <span class="input-group-addon">KB/s</span>
                                    </div>
                                    <p class="text-muted small">Limits the amount of outbound/egress traffic that can pass from the server, measured in <code>KB/s</code>. Setting this value to <code>0</code> will allow a server to use as much outbound bandwidth as necessary.</p>
                                </div>
                            </div>
                        </div>
