...
type Limits struct {
	...
	// Determines the limit of ingress traffic to this container.
	// Represented in kilobytes per second.
	IngressLimit uint32 `json:"ingress_limit"`

	// Determines the limit of egress traffic coming from this container.
	// Represented in kilobytes per second.
	EgressLimit uint32 `json:"egress_limit"`
}
